...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [
         {
            h1: "Independent GxP Auditing<br>Built on 20+ Years of Global Experience",
            p: "EBR Pharma Audit supports pharmaceutical and healthcare organizations in building compliant, risk-based and inspection-ready Quality Management Systems."
         },
         {
            h1: "Regulatory Compliance<br>Without Compromise",
            p: "Extensive experience with FDA, EMA, PMDA and NMPA inspections across Europe, USA, China and Japan."
         },
         {
            h1: "Protecting Quality.<br>Protecting Patients.",
            p: "We deliver structured, transparent and value-driven audits that strengthen compliance and operational performance."
         }
      ];
...
contactForm.addEventListener('submit', function (e) {
   ...
   emailjs.sendForm(
      'service_oz57b9v',         // use the service id of ur emailJS account
      'template_pn3e1zm',       // use ur working template
      this
   ).then(() => {
